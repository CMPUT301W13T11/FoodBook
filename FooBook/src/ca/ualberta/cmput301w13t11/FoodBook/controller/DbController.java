...
public class DbController {
    ...
    // model instances used for interacting with the database
   ...
   ********************************************************************* */
    ...
    /**
     * @param uri The uri of the recipe to be retrieved
     * @return Returns a Recipe the user has stored on their device
     */
   ...
   ********************************************************************* */
     ...
     * @param uri The uri of the recipe to which the photo is to be added.
     */
    ...
    /**
     * @param uri The uri of the recipe from which the photo is to be retrieved.
   ...
   ********************************************************************* */
    /**
     * Associates the Ingredient argument with the given Recipe in the database.
   ...
   ********************************************************************* */
     ...
     * @param The URI of the recipe whose ingredients we wish to receive.
     ...
     * @param oldIngred The Ingredient whose information we wish to overwrite.
     */
